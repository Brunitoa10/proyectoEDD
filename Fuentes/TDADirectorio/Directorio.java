...
public class Directorio {
	...
	/**
	 * Devuelve la ruta absoluta del directorio a explorar como se especific� en el contructor.
	...
	public Iterable<String> archivosDelDirectorio() throws DirectorioException {
		try {
			...
			throw new DirectorioException("Hubo un error: Verifique que el nombre del directorio est� bien.\n" 
	...
	public Iterable<String> subdirectoriosDelDirectorio() throws DirectorioException {
		try {
			...
			throw new DirectorioException("Hubo un error: Verifique que el nombre del directorio esta bien.\n" 
